...
BOT_TOKEN = environ.get('BOT_TOKEN', "7310217905:AAH2QsDWnlz7BxPv8MhGpk4otUm7KV_eaas")
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://te.legra.ph/file/00c2b881ab6dd8680b232.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://te.legra.ph/file/00c2b881ab6dd8680b232.jpg')).split()  # Fsub pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001660466640').split()]  # Channel id for auto indexing (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-100250679068'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002366020288'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002506790368')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002267706334').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002481606158')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002506790368')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002506790368').split()]
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://te.legra.ph/file/00c2b881ab6dd8680b232.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@Rockerzyy_bot')

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @Rockerzyy_bot</b>")
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rockerz2ktg:riyazkk@2003@cluster0.cinlglo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://rockerz2ktg:riyazkk@2003@cluster0.qbbbd2b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002366020288'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/DeiEppudra/5')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '2c7ad3568b5f974e7f7e5ee77f5343192743b1f0')
...
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Rockerz2z')
OWNERID = int(os.environ.get('OWNERID', '1252660463'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Rockerz2z')  # Support group link (make sure bot is admin)
